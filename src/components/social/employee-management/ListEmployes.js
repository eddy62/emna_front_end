                ...
                if (liste.length === 0) {
                    ...
                    liste.forEach((employe) => {
                        let addemploye = {
                            ...
                            dateSortie: employe.dateSortie != null ? dateFns.format(
                            ...
                            typeContrat: employe.intitule != null ? employe.intitule : "/",
            ...
            .then((response) => {
                ...
                response.data.forEach((employe) => {
                    rows.push({
                        ...
                        typeContrat: employe.intitule != null ? employe.intitule : "Aucun",
                        libelle: employe.libelle,
                        clickEvent: () => {
                            this.props.history.push("/detailEmploye/" + employe.id);
                        },
