            ...
            if(contrat.contratSigner){
                return(
                    <div key={contrat.employerId} className="alert alert-success" role="alert">
                        {contrat.contratTitre} - {contrat.employerNom} - {contrat.employerPrenom} -  <Link to={"/detailcontrat/"+contrat.employerId}> voir le détail</Link>
                    </div>
                )
            }else{
                return(
                    <div key={contrat.employerId}>
                        ...
                        <p>{contrat.contratTitre} - {contrat.employerNom} - {contrat.employerPrenom} -  <Link to={"/detailcontrat/"+contrat.employerId}> voir le détail</Link></p>
                    </div>
                );
            }
