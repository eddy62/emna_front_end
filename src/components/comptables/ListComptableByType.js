...
const ListComptableByType = (props) => {
    ...
    const isDesctivePage = (props.location.pathname.trim() === "/users/stvu/comptables/desactive");
    ...
    let toShow = null;
    if(props.location.pathname.trim() === "/users/stvu/comptables/active"){
        toShow = true;
    }else if(props.location.pathname.trim() === "/users/stvu/comptables/desactive"){
        toShow = false;
    }else if(props.location.pathname.trim() === "/users/stvu/comptables/all"){
        toShow = "all";
    }

    let activeComptables = [];
    if(toShow != null){
        activeComptables = currrentPosts.filter(comptable => (comptable.activated === toShow)  && (comptable.authorities[0] === "ROLE_ACCOUNTANT"));

    }
    if(toShow === "all") {
        activeComptables = currrentPosts.filter(comptable => comptable.authorities[0] === "ROLE_ACCOUNTANT")
    }
        ...
        <div className="container">
            <div className="py-4">
                <div className="containe"r>
                    <div className="row">
                        <div className="col-12 shadow-sm p-3 mb-2 bg-white rounded">
                            <span><h1  >{isActivePage ? "Comptables Activés" : isDesctivePage ? "Comptables Desactivés" : "Tous Les Comptables"}</h1></span>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-3">
                            <Link to="/users/stvu/comptables" className="btn btn-primary ml-5" >Accueil Comptable</Link>
                        </div>
                    </div>
                ...
                <table className="table border shadow" >
                    ...
                    <tbody>
                        {
                            activeComptables.map((user, index) => (
                                <tr>
...
export default ListComptableByType;