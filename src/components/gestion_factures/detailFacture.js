...
class DetailFacture extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      facture: this.props.location.state.facture,
    };
  }
  render() {
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body p-0">
                <div class="row p-5">
                  <div class="col-md-6">
                    <h2>Facture #{this.state.facture.numfact}</h2>
                  </div>

                  <div class="col-md-6 text-right">
                    <p class="text-muted">Date : {this.state.facture.date}</p>
                  </div>
                </div>
